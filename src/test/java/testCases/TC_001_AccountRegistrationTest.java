...
public class TC_001_AccountRegistrationTest extends BaseClass{
	...
	public void test_account_Registration()
	{
		...
		logger.debug("capturing debug logs.......");     // tester usualy do .info only,  debug  n all are used for gettting application logs also,  and  this logs will be displayed only if we provide <Root level="Debug"> in  xml file
